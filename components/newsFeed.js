...
function NewsFeed (){
    ...
    return(
        <div className="px-4 mb-40 mt-3 h-inherit bg-green-100 dark:bg-gray-900 dark:text-gray-200 md:px-16">
            <div className="flex justify-between">
                ...
                <div className="mb-28 pb-10">
            <h2 className="cursor-pointer font-semibold text-xl text-green-100" > .</h2>
          </div>
        </div>
    )
}
